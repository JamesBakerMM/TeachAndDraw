...
export class Maffs {
    ...
    dot(x1, y1, x2, y2) {
        if (!Number.isFinite(x1)) {
            throw new Error(
                ErrorMsgManager.numberCheckFailed(x1, "x1 must be a number")
            );
        }
        if (!Number.isFinite(y1)) {
            throw new Error(
                ErrorMsgManager.numberCheckFailed(y1, "y1 must be a number")
            );
        }
        if (!Number.isFinite(x2)) {
            throw new Error(
                ErrorMsgManager.numberCheckFailed(x2, "x2 must be a number")
            );
        }
        if (!Number.isFinite(y2)) {
            throw new Error(
                ErrorMsgManager.numberCheckFailed(y2, "y2 must be a number")
            );
        }
...
Object.defineProperty(Maffs.prototype, "rescale", {
    value: Maffs.prototype.rescale,
    writable: false,
    configurable: false,
});

Object.defineProperty(Maffs.prototype, "dot", {
    value: Maffs.prototype.dot,
    writable: false,
    configurable: false,
});