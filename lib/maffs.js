export class Maffs {
     ...
     */
    isNum(value){
        //update to return false if mismatch
        //have it console.warn about NaN 
        //have it console.info about Infinity 
    ...
    atan2(x,y) {
        if(this.#pen.debug){
            console.warn("Most implementations of atan2 have a parameter pattern of y,x. We use x,y for consistency");
        }
        this.isNum(x);
        this.isNum(y);
