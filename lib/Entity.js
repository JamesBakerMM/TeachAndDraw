...
export class Entity {
    ...
    constructor(pen, x, y) {
        ...
        this.positionPrevious = new Point(pen,this.position.x,this.position.y);
        ...
        const approvedColors = [
            Paint.white,
            Paint.palegreen, Paint.green, Paint.darkgreen,
            Paint.paleblue, Paint.blue, Paint.darkblue,
            Paint.palered, Paint.red, Paint.darkred,
            Paint.palepurple, Paint.purple, Paint.darkpurple,
            Paint.paleaqua, Paint.aqua, Paint.darkaqua,
            Paint.palepink, Paint.pink, Paint.darkpink,
            Paint.paleyellow, Paint.yellow, Paint.darkyellow,
            Paint.palebrown, Paint.brown, Paint.darkbrown,
            Paint.paleorange, Paint.orange, Paint.darkorange
        ];
    ...
    get direction() {
        const degreeReadjustedValue =
            this.#pen.math.unadjustDegreesFromZero(this.#direction);
    ...
    move() {
        ...
        if (this.velocity.x != 0) {
            this.x += (this.velocity.x * this.#pen.time.timeMultiplier)*this.#pen.fractionOfMovement;
        }
        if (this.velocity.y != 0) {
            this.y += (this.velocity.y * this.#pen.time.timeMultiplier)*this.#pen.fractionOfMovement;
        }
