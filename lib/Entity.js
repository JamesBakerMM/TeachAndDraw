...
export class Entity {
     ...
     */
    getAngleToPoint(x,y) {
        return $.math.adjustDegressSoTopIsZero($.math.atan2(this.y-y,this.x-x));
    }
    ...
    set asset(value) {
        ...
        for(let asset of this.#assets){ //remove the cloned asset wrappers currently attached
            asset.remove();
        }   
