...
export class Entity {
    ...
    move(){
        ...
        if (this.velocity.x != 0) {
            ...
            // console.log("seconds elapsed",this.#pen.time.secondsElapsed);
            // console.log("ss",this.velocity.x * this.#pen.time.secondsElapsed);
            this.x += this.velocity.x * this.#pen.time.secondsElapsed;
        }
        if (this.velocity.y != 0) {
            // this.y += this.velocity.y;
            this.y += this.velocity.y * this.#pen.time.secondsElapsed;
        }
