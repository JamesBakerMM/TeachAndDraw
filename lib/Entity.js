...
export class Entity {
    ...
    move() {
        ...
        if (this.velocity.x != 0) {
            this.x += (this.velocity.x * this.#pen.time.timeMultipler)*this.#pen.fractionOfMovement;
        }
        if (this.velocity.y != 0) {
            this.y += (this.velocity.y * this.#pen.time.timeMultipler)*this.#pen.fractionOfMovement;
        }
