...
/**
 * @typedef {import("./TeachAndDraw.js").Pen} Pen
 */
...
export class Entity {
    ...
    set speed(value) {
        ...
        this.velocity.x = this.#pen.math.cos(this.#direction) * value;
        this.velocity.y = this.#pen.math.sin(this.#direction) * value;
    }
    ...
    set direction(value) {
        ...
        this.velocity.x = this.#pen.math.cos(adjustedDegree) * speed;
        this.velocity.y = this.#pen.math.sin(adjustedDegree) * speed;
    }
     ...
     */
    get direction() {
        return this.#pen.math.unadjustDegreesFromZero(this.#direction);
    }
     ...
     */
    getAngleToPoint(x, y) {
        const angle = this.#pen.math.atan2(this.y - y, this.x - x);
        return this.#pen.math.adjustDegressSoTopIsZero(angle);
    }
