...
export class Entity {
    ...
    set asset(asset){
        ...
        if(asset.type==="animation"){ 
            ...
            const nuAnimWrapper = new Animation( this.x, this.y, this.#pen, ...asset );
            nuAnimWrapper.delay=asset.delay;
            nuAnimWrapper.looping = asset.looping;
            nuAnimWrapper.playing = asset.playing;
            nuAnimWrapper.rotation = asset.rotation;
            nuAnimWrapper.frame = asset.frame;
        ...
        if(asset.type==="image"){
            ...
            const nuImgWrapper=asset.clone(asset.x,asset.y,asset.data,this.#pen);
            nuImgWrapper.w=asset.w;
            nuImgWrapper.h=asset.h;
