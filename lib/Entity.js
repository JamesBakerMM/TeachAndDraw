...
export class Entity {
     ...
     * @property {Point} positionPrevious - The previous position of the entity.
     ...
     * @param {ImgWrapper} value - The image to attach.
     */
    set asset(value) {
        if (value === undefined) {
            throw Error(
     ...
     * @returns {ImgWrapper} The asset of the entity.
     */
    get asset() {
