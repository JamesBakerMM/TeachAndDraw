...
export class Entity {
    ...
    set direction(value){
        ...
        const adjustedDegree=this.#pen.math.adjustDegressSoTopIsZero(value);
        ...
        // set velocities scaled by this.#speed
    }
    get direction(){
