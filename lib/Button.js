...
export class Button extends Entity {
     ...
     * @param {Pen} pen - the pen instance bound to
   ...
   set down(value) {
    ...
    get released() {
        ...
        if (this.isHovered()) {
            this.#released = this.#pen.mouse.leftReleased;
        } else {
            this.#released = false;
        }
    ...
    update() {
        ...
        this.#released = (this.#hovered && this.#pen.mouse.leftReleased);
        this.#down = (this.#hovered && this.#pen.mouse.leftDown);
    }
