...
//     static #isInRect(px, py, cx, cy, w, h) {
//         return cx-w/2<=px && px<cx+w/2 && cy-h/w<=py && py<cy+h/w;
//     }


//     update( rotation ) {
//         const mouse = Vector.temp(this.#tad.mouse.x, this.#tad.mouse.y);
//         const rect  = Vector.temp(this.#entity.x, this.#entity.y);
//         mouse.subtract(rect);
//         mouse.rotate(-this.#entity.rotation);
//         mouse.add(rect);

//         this.#mouse = mouse;

//         this.#hovered = GuiCommon.#isInRect(
//             mouse.x, mouse.y, this.#entity.x, this.#entity.y, this.#entity.w, this.#entity.h
//         );
//     }
