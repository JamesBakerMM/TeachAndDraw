...
export class Collider extends ShapedAssetEntity {
    ...
    constructor(pen, x, y, w, h = w, type = "circle") {
        ...
        this.flip = new Flip();
        this.#lifespan="immortal";
        this.#lastFrameLifespanDecremented=-1; //this is to ensure if someone calls .draw() multiple times in one frame it does not decrement the lifespan that many times
