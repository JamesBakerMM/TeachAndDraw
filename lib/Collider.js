    ...
    updateCollision() {
        ...
        if (this.collisionShape != null) {
            if (this.collisions.size > 0) {
                this.x += this.collisionShape.newX;
                this.y += this.collisionShape.newY;

                this.velocity.x += this.collisionShape.newVelocityX;
                this.velocity.y += this.collisionShape.newVelocityY;

                let bounce = this.bounciness / 100;
