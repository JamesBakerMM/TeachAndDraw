...
export class Animation extends Array {
     ...
     * @memberof Animation
     * @example
     * const animation = new Animation(0, 0, pen, img1, img2, img3);
     * animation.delay = 10;
     ...
     * @param {Pen} pen - The drawing tool used for rendering the animation.
     * @param {...ImgWrapper} imgs - An array of image objects for the animation frames.
     * @returns {Animation} An instance of Animation.
     * @property {number} x - The x-coordinate of the animation.
     * @property {number} y - The y-coordinate of the animation.
     * @property {number} rotation - The rotation angle of the animation in degrees.
     * @property {number} delay - The delay before the animation starts (in frames).
     * @property {boolean} playing - The playing status of the animation.
     * @property {boolean} looping - The looping status of the animation.
     * @property {number} frame - The current frame of the animation.
     * @property {string} type - The type of the animation.
     * @constructor
     */
     ...
     * @param {number} x - The x-coordinate to draw the animation.
     * @param {number} y - The y-coordinate to draw the animation.
