...
export class CollisionManager {
    ...
    addCollisionEvent(collider1, collider2) {
        ...
        this.#collidesMap[newKey]=[collider1,collider2];
    ...
    handleCollisions() {
        ...
        for (const [key, value] of Object.entries(this.#collidesMap)) {
            let overlaps = this.collidersOverlap(value[0], value[1]);
            if (overlaps) {
                this.doCollide(value[0], value[1]);
            }
        }
        this.#collidesMap={};
    }
