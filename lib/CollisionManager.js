...
export class CollisionManager {
    ...
    doCollideCircleToPolygon(circle, polygon) {
        ...
        let velocityRot = CollisionUtilities.getVectorOfPointTravelledAroundPoint(polygon.x, polygon.y, intersect.x, intersect.y, polygon.rotationalVelocity);

        //Get velocity vector
        let velocityV = new CollisionVector(polygon.velocity.x - circle.velocity.x - velocityRot.x, polygon.velocity.y - circle.velocity.y - velocityRot.y);
    ...
    doCollideBoxToBox(collider1, collider2) {
        ...
        while(collides && count < 100) {
            ...
            collides = collider2.collisionShape.doesPolygonIntersect(collider1.collisionShape, collider1.x + collider1.collisionShape.newX, collider1.y + collider1.collisionShape.newY);
        }
