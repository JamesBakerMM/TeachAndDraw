...
export class CollisionManager {
    ...
    doCollideCircleToCircle(circle1, circle2) {
        ...
        if (!circle1.static) {
            ...
            const collisionCount = circle2.collisions.size;
        ...
        if (!circle2.static) {
            ...
            const collisionCount = circle1.collisions.size;
    ...
    doCollideCircleToPolygon(circle, polygon) {
        ...
        if (!circle.static) {
            ...
            const collisionCount = polygon.collisions.size;
        ...
        if (!polygon.static) {
            ...
            const collisionCount = circle.collisions.size;
    ...
    doCollideBoxToBox(collider1, collider2) {
        ...
        if (!collider1.static) {
            ...
            const collisionCount = collider2.collisions.size;
        ...
        if (!collider2.static) {
            ...
            const collisionCount = collider1.collisions.size;
