...
export class CollisionManager {
    ...
    collidesOrOverlapsGroupToCollider(entities, collider, group1Id, overlaps) {
        ...
        if(overlaps){
            let result = false;
            console.log("OVERLAPS: collidesOrOverlapsGroupToCollider")
            ...
            if (!result) {
                console.log("collidesOrOverlapsGroupToCollider",group1Id,collider.id,"overlaps",collider.overlays,"colliders",collider.collisions)
        ...
        for (let j = 0; j < this.#collisionCounter; j += 3) {
            ...
            if (overlaps) {
                ...
                if (type === 1) {
                    ...
                    console.log("adding overlays",c1.overlays,c2.overlays)
                }
            }
        }
