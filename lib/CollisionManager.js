...
export class CollisionManager {
    ...
    constructor(pen){
        ...
        this.#collisionGroups = new Array();
    ...
    addCollideObject(entities) {
        this.#collisionGroups.push(entities);
    }

    collideQuad1(entities) {
        this.#quadTree.makeTree(entities);
        this.collideQuad2(this.#quadTree.getTree());
    }
    ...
    handleCollisions() {
        ...
        for (let j = 0; j < this.#collisionGroups.length; j++) {
            this.collideQuad1(this.#collisionGroups[j]);
        }
