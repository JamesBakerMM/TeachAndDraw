...
${Video.loading.title} | ${Video.loading.url}
    ...
    setupCanvas() {
        ...
        if (this.debug) {
            const data = this.performanceMetrics.measurePerformance();
            this.performanceMetrics.printMeasurement(data);

            const trends = this.performanceMetrics.computeTrends();
            this.performanceMetrics.printTrends(trends);
        }
