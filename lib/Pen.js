...
${Video.loading.title} | ${Video.loading.url}
    ...
    setupCanvas() {
        ...
        if (localStorage.getItem("groupFasterThanArray") === null) {
            if (Performance.groupFasterThanArray(this)) {
                localStorage.setItem("groupFasterThanArray", "true");
            } else {
                localStorage.setItem("groupFasterThanArray", "false");
            }

        } else {
            let groupFaster = (localStorage.getItem("groupFasterThanArray") == "true");
            console.log(`groupFaster: ${groupFaster}`);
        }
