...
export class Shape {
    ...
    /**
     * Sets the horizontal alignment for drawing shapes. 
     * The alignment determines the starting point of the shape in the horizontal direction.
     * @param {("center"|"left"|"right")} value - The horizontal alignment setting. 
     * Accepted values are:
     * - "center": Aligns the shape's center with the specified x-coordinate.
     * - "left": Aligns the shape's left edge with the specified x-coordinate.
     * - "right": Aligns the shape's right edge with the specified x-coordinate.
     * @throws {Error} Throws an error if the provided value is not one of the accepted values.
     */
    set xAlignment(value) {
        if (this.xAlignOptions.has(value) === false) {
            throw new Error(
                `Invalid value for alignment. You provided "${value}". Valid values are: ${[
                    ...this.xAlignOptions,
                ].join(", ")}`
            );
        }
    ...
    /**
     * Sets the vertical alignment for drawing shapes. 
     * The alignment determines the starting point of the shape in the vertical direction.
     * @param {("center"|"top"|"bottom")} value - The vertical alignment setting. 
     * Accepted values are:
     * - "center": Aligns the shape's center with the specified y-coordinate.
     * - "top": Aligns the shape's top edge with the specified y-coordinate.
     * - "bottom": Aligns the shape's bottom edge with the specified y-coordinate.
     * @throws {Error} Throws an error if the provided value is not one of the accepted values.
     */
    ...
    /**
     * Validates the provided state object for the shape.
