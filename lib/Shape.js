...
export class Shape {
     ...
     * @param {string} newState.shapeAlignmentX
     * @param {string} newState.shapeAlignmentY
     * @param {number} newState.shapeStrokeWidth
     * @param {number} newState.shapeStrokeDash
     * @param {boolean} newState.movedByCamera
     */
    set state(newState) {
        ...
        this.movedByCamera = newState.movedByCamera;
    }
}
