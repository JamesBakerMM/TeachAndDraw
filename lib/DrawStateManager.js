...
export class DrawStateManager {
    ...
    reset() {
        ...
        this.#pen.shape.rotation = 0;
        this.#pen.shape.movedByCamera = false;
        ...
        this.#pen.text.rotation = 0;
        this.#pen.text.movedByCamera = false;
    }
}
...
export class DrawState {
    ...
    constructor(pen) {
        ...
        this.shapeMovedByCamera = pen.shape.movedByCamera;
        ...
        this.textMovedByCamera = pen.text.movedByCamera;
    }
}
