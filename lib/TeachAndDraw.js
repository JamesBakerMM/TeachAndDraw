...
export class Tad {
    ...
    constructor(
        ...
        this.#muteButton = this.makeButton(0, 0, 100, 100, "");
        this.#muteButton.asset = this.loadImage(0, 0, "../../images/mute.png");
        this.#paused = false;
        ...
        if (!document.hidden) {
            ...
            if (this.#assets.isLoaded() === false) {
                ...
                try {
                    ...
                    if (this.sound.context.state === "suspended" && this.#soundsLoaded > 0) {
                        this.#muteButton.x = this.w-50;
                        this.#muteButton.y = this.h-50;
