...
export class Group extends Array {
    ...
    static cleanup() {
        for (let g = Group.all.length - 1; g >= 0; g--) {
            ...
            if (group) {
                ...
                console.log("[Beta:Ignore this] Clearing Memory Cache...");
    ...
    cleanup() {
        for (let i = this.length - 1; i >= 0; i--) {
            const item = this[i];
            if (item && typeof item.exists === "boolean" && item.exists === false) {
                this.splice(i, 1);
            }
        }
    }
    ...
    /**
     * Returns a random item from the group.
     * @returns {any} A random item from the group.
     * @throws {Error} If the group is empty.
     */
    random() {
        if (this.length === 0) {
            throw new Error("Cannot get a random item from an empty group");
        }
    ...
    /**
     * "Shuffles" i.e Randomises the order of items in the group.
     */
    shuffle() {
        for (let i = this.length - 1; i > 0; i--) {
    ...
    //@ts-expect-error
    map() {
        throw new Error(`Groups do not support using .map() both for technical and educational reasons look into a for loop or for of loop instead :)`);
    }

    //@ts-expect-error
    filter() {
        throw new Error(`Groups do not support using .filter() both for technical and educational reasons look into a for loop or for of loop instead :)`);
    }

    reduce() {
        throw new Error(`Groups do not support using .reduce() both for technical and educational reasons look into a for loop or for of loop instead :)`);
    }

    //--------- HELPER GETTER/SETTERS TO DETECT COMMON MISTAKES
    get play() {
        const msg = "Groups do not have a .play property! Did you mean to access an item inside of it that does?"
    ...
    get h() {
        const msg = "Groups do not have a .h property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    get w() {
        const msg = "Groups do not have a .w property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    get duration() {
        const msg = "Groups do not have a .duration property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    get x() {
        const msg = "Groups do not have a .x property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    set y(value) {
        const msg = "Groups do not have a .y property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    set velocity(value) {
        const msg = "Groups do not have a .velocity property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    set image(value) {
        const msg = "Groups do not have a .image property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    set static(value) {
        const msg = "Groups do not have a .static property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    set speed(value) {
        const msg = "Groups do not have a .speed property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
    ...
    set direction(value) {
        const msg = "Groups do not have a .direction property! Did you mean to access an item inside of it that does?"
        throw new TypeError(msg)
    }
