...
export class Group extends Array {
    ...
    /** @type {string[]} index for using #approvedColours as a circular buffer. */
    static #approvedColours = undefined;
    ...
    constructor(...elements) {
        ...
        if (Group.#approvedColours === undefined) {
        ...
        this.fill = Group.#approvedColours[Group.#approvedColoursIdx];
        Group.#approvedColoursIdx = (Group.#approvedColoursIdx + 1) % Group.#approvedColours.length;
    ...
    overlaps(collideableEntity) {
        ...
        const thisValidGroupType = (this.type === "Collider" || this.type === "empty");
        ...
        const otherValidGroupType = (collideableEntity.type === "Collider" || collideableEntity.type === "empty"); 
        ...
        const msg = ErrorMsgManager.colliderCheckFailed(collideableEntity) || "";
        throw new Error(
            `Unsupported! ${collideableEntity}:${typeof collideableEntity}`+msg
        );
    }
