...
export class Debug {
    ...
    static drawCollider(pen,collider) { 
        ...
        pen.colour.fill="blue";
        pen.shape.oval(collider.left,collider.y,10)
        pen.shape.oval(collider.right,collider.y,10)
        pen.shape.oval(collider.x,collider.top,10)
        pen.shape.oval(collider.x,collider.bottom,10)
        pen.state.load();
    }
    static drawPen(pen) {
