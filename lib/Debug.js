...
/**
 * @typedef {import("./Camera2.js").Camera} Camera
 */
...
export class Debug {
     ...
     * @param {Camera2} camera - The camera object to display information for.
    ...
    static constructCameraInfoPane(camera) {
        let html = `
            ...
            <br/>
                    <hr>
                    <strong>Center</strong><br>xCenter:<strong>${camera.x}</strong> |  yCenter:<strong>${x.yCenter}</strong>
                    <hr>
        `;
        return html;
    }
    ...
    static constructInfoPane(tad) {
        ...
        let html = `                    
            ...
            tad.shape.alignment.y
                    ...
                    <hr>
        `;
        // html += Debug.constructCameraInfoPane(tad.camera2);
     ...
     * @static
     */
    static drawCamera(tad, center = { x: 0, y: 0 }) {
