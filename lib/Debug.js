...
export class Debug {
    ...
    static drawCollider(pen, collider) {
        ...
        const halfWidth = collider.w / 2;
        const halfHeight = collider.h / 2;
    ...
    static drawGrid(pen) {
        ...
        for (let i = 0; i < pen.w / INCREMENT; i++) {
            ...
            pen.text.draw(i * INCREMENT, INCREMENT-15, i * INCREMENT);
        }
        ...
        for (let y = 0; y < pen.h / INCREMENT; y++) {
            ...
            pen.colour.fill = DULL_GREEN;
            pen.text.draw(INCREMENT, INCREMENT * y-15, y * INCREMENT);
        }
    }
