...
export class Text {
     ...
     * @param {number} y - The y-coordinate where the text will be drawn.
     * @param {string} content - The text content to be drawn.
     *                                If set to 0 or left unspecified, no wrapping is applied. If given a number will convert it to a string for convenience.
    ...
    print(x, y, content) {
        ...
        //jb: quiet support for valid numbers being printable
    ...
    set font(newFont) {
        ...
        if (this.#tad.text.customFonts.includes(newFont)) {
            this.#font = `${newFont}, Times New Roman, serif`;
        }
