...
export class Img extends Image {
    ...
    #h
    #pen
    constructor(x = 0, y = 0, pen, filepath,job) {
        super();
        this.id = Img.getId();
    ...
    drawDebug(){
        ...
        this.#pen.text.alignment="left";
        this.#pen.text.baseline="bottom";
        ...
        this.#pen.colour.fill = "#ffb900";
        this.#pen.text.draw(0+15, 0 + 3, `x:${this.x.toFixed(0)} y:${this.y.toFixed(0)} rot:${this.rotation}`);
        //end static label
        this.#pen.context.rotate(this.#pen.math.degreeToRadian(this.rotation));
        this.#pen.colour.fill = "#ffb900";
    }
