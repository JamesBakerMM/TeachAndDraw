    ...
    */
    set x(value){
        ...
        if(this.#validXValues.has(value)===false){
            throw new Error(
                `Invalid value for alignment.x You provided "${value}". Valid values are: ${Array.from(this.#validXValues).join(
                    '", "'
                )}`
            );
        }
    ...
    */
    set y(value){
        ...
        if(this.#validYValues.has(value)===false){
            throw new Error(
                `Invalid value for alignment.y You provided "${value}". Valid values are: ${Array.from(this.#validYValues).join(
                    '", "'
                )}`
            );
        }
